...
async function initApp() {
  ...
  const [symbolsData, symbols2Data, kaomojiData, fontsData, xiaohongshuData, emojiData, plantsData, mysticalData, tarotData, objectsData] = await Promise.all([
    fetchData('symbols.json'),
    fetchData('symbols2.json'),
    fetchData('kaomoji.json'),
    fetchData('fonts.json'),
    fetchData('xiaohongshu.json'),
    fetchData('emoji.json'),
    fetchData('plants.json'),
    fetchData('mystical.json'),
    fetchData('tarot.json'),
    fetchData('objects.json'),
  ]);
